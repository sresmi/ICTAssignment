...
public class Wish_list {
    ...
    public void delete_Cart() throws InterruptedException {
        ...
        new WebDriverWait(driver, 20).until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"container\"]/div/div[2]/div/div/div[1]/div/div[2]/div/div[2]/div/div[1]"))).click();
